...
# CMD ["flask", "run", "--host=0.0.0.0", "--port=$PORT"] # Ensure this line IS commented out
...
CMD ["gunicorn", "--bind", "0.0.0.0:$PORT", "--workers", "1", "--threads", "8", "--timeout", "0", "app:app"] # Ensure this line IS NOT commented out